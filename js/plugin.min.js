    ...
    (a.fn.scrollUp = function (b) {
        ...
        (a.fn.scrollUp.init = function (d) {
            ...
            e.scrollImg || f.html(e.scrollText),
                ...
                f.click(function (b) {
                    b.preventDefault(), a("html, body").animate({ scrollTop: 0 }, e.topSpeed, e.easingType);
                });
        }),
...
!(function (t) {
    ...
    t.fn.counterUp = function (e) {
        var a,
            n = t.extend({ time: 400, delay: 10, formatter: !1, callback: function () {} }, e);
            ...
            var e = t(this),
                ...
                u = function () {
                    ...
                    for (var d = u; d >= 1; d--) {
                        ...
                        if (i) for (; /(\d+)(\d{3})/.test(p.toString()); ) p = p.toString().replace(/(\d+)(\d{3})/, "$1,$2");
                ...
                n = function (e) {
                    if (e.querySelector("ul") || "UL" === e.tagName) {
                        ...
                        var n,
                            ...
                            T = !1;
                        Z.customToggle
                            ? (d = R.getElement(Z.customToggle)) && (d.classList.add("hc-nav-trigger", E), d.addEventListener("click", K))
                            : ((d = R.createElement("a", { href: "#", class: "hc-nav-trigger " + E, "aria-label": (Z.ariaLabels || {}).open }, R.createElement("span"))).addEventListener("click", K), e.insertAdjacentElement("afterend", d)),
                        ...
                        var w = function (e, t, n) {
                                if ("number" == typeof t && ("number" == typeof e || k.length)) {
                                    ...
                                    if (
                                        ...
                                        var r = a[0],
                                            i = a[a.length - 1];
                                        "number" == typeof e ? a[e].focus() : (k[k.length - 1].focus(), k.pop()),
                            ...
                            M = function () {
                                ...
                                l.add(".hc-offcanvas-nav." + E + ".nav-position-left .nav-container", "transform: translate3d(-" + e + ", 0, 0)"),
                                    ...
                                    Z.pushContent && p && n && l.add(R.getElementCssTag(p), "transition: " + n + " " + u + "ms " + a),
                                    l.insert();
                            },
                            i = function (e) {
                                ...
                                (R.isNumeric(a) || -1 !== a.indexOf("px")) && (b = parseInt(a)),
                                    (R.isNumeric(r) || -1 !== r.indexOf("px")) && (g = parseInt(r)),
                                    te(["disableAt", "position"]) && l.reset(),
                                    l.add(".hc-offcanvas-nav." + E, "display: block", n),
                                    l.add(".hc-nav-original." + E, "display: none", n),
                                    l.add(".hc-nav-trigger." + E, "display: " + (t && "none" !== t ? t : "block"), n),
                                    -1 !== ["left", "right"].indexOf(Z.position) ? l.add(".hc-offcanvas-nav." + E + " .nav-container", "width: " + a) : l.add(".hc-offcanvas-nav." + E + " .nav-container", "height: " + r),
                                    ...
                                    l.insert(),
                                    (!e || (e && te("pushContent"))) && (p = R.getElement(Z.pushContent)),
                                ...
                                var s = c.classList.contains(se),
                                    o = [
                                        ...
                                        s ? se : "",
                                        Z.rtl ? "rtl" : "",
                                        !Z.labelClose || ("" === Z.labelClose && Z.insertClose) ? "close-no-label" : "",
                                    ]
                                        .join(" ")
                                        .trim()
                                        .replace(/  +/g, " ");
                            ...
                            P = function () {
                                ...
                                r = (function o(e, t) {
                                    ...
                                    Array.prototype.forEach.call(e, function (e) {
                                        ...
                                        null !== e.getAttribute("data-nav-active") && ((m = t), e.removeAttribute("data-nav-active")),
                                            Array.prototype.forEach.call(e.children, function (e) {
                                                var t = null !== e.getAttribute("data-nav-custom-content"),
                                                    ...
                                                    r = a.length
                                                        ...
                                                        : [],
                                                    i = null;
                                                r.length && (R.data(e, "hc-uniqid") ? (i = R.data(e, "hc-uniqid")) : ((i = Math.random().toString(36).substr(2)), R.data(e, "hc-uniqid", i))),
                                                    null !== e.getAttribute("data-nav-active") && ((m = i), e.removeAttribute("data-nav-active")),
                                                    s.items.push({ id: i, classes: e.getAttribute("class") || "", content: n, custom: t, subnav: r.length ? o(r, i) : [], highlight: null !== e.getAttribute("data-nav-highlight") });
                                            }),
                                            n.push(s);
                                    });
                                    return n;
                                    ...
                                    [t[0]].concat(
                                        Array.prototype.filter.call(t[0].parentNode.children, function (e) {
                                            return e !== t[0];
                                        })
                                    )),
                                    null
                            ...
                            _ = function (e) {
                                ...
                                !(function m(e, t, y, b, n, a) {
                                    ...
                                    e.forEach(function (e, t) {
                                        ...
                                        r.appendChild(h),
                                            Z.keepClasses && e.classes && h.classList.add.apply(h.classList, e.classes.split(" ")),
                                            ...
                                            e.items.forEach(function (e, t) {
                                                ...
                                                i
                                                    ...
                                                    "#" === r.getAttribute("href") && r.addEventListener("click", R.preventDefault),
                                                    Z.closeOnClick &&
                                                        (W()
                                                            ? "A" !== r.tagName ||
                                                              "false" === r.dataset.navClose ||
                                                              (null !== r.getAttribute("disabled") && "false" !== r.getAttribute("disabled")) ||
                                                              (e.subnav.length && (!r.getAttribute("href") || "#" === r.getAttribute("href").charAt(0))) ||
                                                              r.addEventListener("click", G)
                                                            : "A" !== r.tagName || "false" === r.dataset.navClose || (null !== r.getAttribute("disabled") && "false" !== r.getAttribute("disabled")) || r.addEventListener("click", G));
                                                var s = R.createElement("li");
                                                if (
                                                    (s.appendChild(r),
                                                    h.appendChild(s),
                                                    Z.keepClasses && e.classes && (s.className = e.classes),
                                                    e.highlight && s.classList.add("nav-highlight"),
                                                    R.wrap(r, R.createElement("div", { class: "nav-item-wrapper" })),
                                                    ...
                                                    if ((A[l] || (A[l] = 0), s.classList.add("nav-parent"), W())) {
                                                        ...
                                                        var p = function (e) {
                                                            e.addEventListener("click", function (e) {
                                                                ...
                                                                e.setAttribute("aria-haspopup", "overlap" === Z.levelOpen),
                                                        ...
                                                        if (
                                                            ...
                                                            (v = !0 === Z.levelTitles ? n[0].textContent.trim() : ""),
                                    ...
                                    if (y && void 0 !== n && !1 !== Z.insertBack && "overlap" === Z.levelOpen) {
                                        ...
                                        R.wrap(o, R.createElement("div", { class: "nav-item-wrapper" })),
                                    ...
                                    if (0 === y && !1 !== Z.insertClose) {
                                        ...
                                        (Z.labelClose && "" !== Z.labelClose) || u.setAttribute("aria-label", (Z.ariaLabels || {}).close),
                                            R.wrap(u, R.createElement("div", { class: "nav-item-wrapper" })),
                            ...
                            t = function (t) {
                                return function (e) {
                                    ("left" !== Z.position && "right" !== Z.position) ||
                                        ...
                                        "doc" === t
                                            ? T || (ae.addEventListener("touchmove", q, R.supportsPassive), ae.addEventListener("touchend", D, R.supportsPassive))
                                            : ((T = !0), v.addEventListener("touchmove", H, R.supportsPassive), v.addEventListener("touchend", I, R.supportsPassive)));
                                };
                            },
                            j = function (e, t) {
                                ne.addEventListener("touchmove", R.preventDefault, R.supportsPassive),
                                    (c.style.visibility = "visible"),
                                    (v.style[R.browserPrefix("transition")] = "none"),
                                    R.setTransform(v, e, Z.position),
                                    p && ((p.style[R.browserPrefix("transition")] = "none"), R.setTransform(p, t, Z.position));
                            },
                            B = function (e, t, n, a) {
                                void 0 === t && (t = !0),
                                    void 0 === n && (n = !1),
                                    void 0 === a && (a = !1),
                                    ne.removeEventListener("touchmove", R.preventDefault, R.supportsPassive),
                                    (v.style[R.browserPrefix("transition")] = ""),
                                    R.setTransform(v, n, Z.position),
                                    p && ((p.style[R.browserPrefix("transition")] = ""), R.setTransform(p, a, Z.position)),
                                    "open" === e
                                        ? Y()
                                        : (G(),
                                          t
                            ...
                            q = function (e) {
                                var t = 0 - (o - e.touches[0].clientX),
                                    ...
                                    a = b + n;
                                (t = "left" === Z.position ? Math.min(Math.max(t, 0), a) : Math.abs(Math.min(Math.max(t, -a), 0))),
                                    (("left" === Z.position && o < 50) || ("right" === Z.position && o > ae.clientWidth - 50)) && ((N = !0), j(0 - (b - t), Math.abs(t)));
                            },
                            D = function e(t) {
                            ...
                            H = function (e) {
                                ...
                                if (!(Math.abs(t) < Math.abs(n))) {
                                    var a = "overlap" === Z.levelOpen ? F() * Z.levelSpacing : 0,
                                        r = b + a;
                                    (t = "left" === Z.position ? Math.min(Math.max(t, -r), 0) : Math.min(Math.max(t, 0), r)),
                                        (("left" === Z.position && t < 0) || ("right" === Z.position && 0 < t)) && ((N = !0), j(-Math.abs(t) + a, r - Math.abs(t)));
                                }
                            },
                            I = function e(t) {
                        ...
                        i(),
                            P(),
                            _(),
                            !0 === Z.removeOriginalNav ? e.parentNode.removeChild(e) : e.classList.add("hc-nav-original", E),
                            "prepend" === Z.bodyInsert ? ae.body.insertBefore(c, ae.body.firstChild) : "append" === Z.bodyInsert && ae.body.appendChild(c),
                            !0 === Z.expanded && ((h = !0), Y()),
                            Z.swipeGestures && (v.addEventListener("touchstart", t("nav"), R.supportsPassive), ae.addEventListener("touchstart", t("doc"), R.supportsPassive)),
                        ...
                        var U = function (e, t, n) {
                            ...
                            if (a) {
                                ...
                                if (
                                    ...
                                    n && "overlap" === Z.levelOpen && (s.removeEventListener("click"), s.addEventListener("click", R.stopPropagation), R.setTransform(v, (e - 1) * Z.levelSpacing, Z.position), p))
                                ) {
                    ...
                    function Y(e, t) {
                        if (
                            ...
                            ((function () {
                                ...
                                Z.disableBody &&
                                    ((y = ne.pageYOffset || re.scrollTop || ae.documentElement.scrollTop || ae.body.scrollTop),
                            ...
                            var n;
                            if (("number" != typeof e && !R.isNumeric(e)) || ("number" != typeof t && !R.isNumeric(t)))
                                m
                    ...
                    function G() {
                        if (X()) {
                            if (
                                ...
                                Z.disableBody && (ae.body.classList.remove("hc-nav-open"), re.classList.remove("hc-nav-yscroll"), y))
                            ) {
                    ...
                    function $(t, n, e) {
                        ...
                        c._eventListeners["open.level"] &&
                            c._eventListeners["open.level"].forEach(function (e) {
                                e.fn(R.customEventObject("open.level", c, o, { currentLevel: t, currentIndex: n }), Object.assign({}, Z));
                            }),
                            C && (w(0, t, n), (C = !1));
                    }
                    function J(t, e) {
                        for (var n = t; n <= Object.keys(A).length; n++)
                            ...
                            else if (0 !== t || Z.closeOpenLevels) for (var a = 0; a < A[n]; a++) U(n, a, n === t);
                            else;
                        if (0 < t && c._eventListeners["close.level"]) {
                            ...
                            c._eventListeners["close.level"].forEach(function (e) {
                                e.fn(R.customEventObject("close.level", c, r, { currentLevel: t - 1, currentIndex: Q() }), Object.assign({}, Z));
                            });
                        }
                        C && (w(null, t - 1), (C = !1));
                    }
